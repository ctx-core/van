...
>(derived__new:(ctx:ctx_T)=>state_T, be__params?:be__params_T):be_derive_pair_T<state_T, ctx_T>
export declare function be_derive_pair__new<
	state_T extends State<unknown> = State<any>,
	ctx_T extends Ctx = Ctx,
>(id:string|null|undefined, derive__new:(ctx:ctx_T)=>state_T, be__params?:be__params_T):be_derive_pair_T<state_T, ctx_T>
